...
`undef FIXED_POINT_ARITH_VH
`undef VECTOR_ARITH_VH
`undef SDF_PRIMITIVES_VH
...
`include "sdf_primitives.vh"
    ...
    wire [`W-1:0] hash_y2 = fp_gt(hash, `FP_HALF) ? p_z : p_z; 
...
module sdf_query (
    ...
    assign sdf_out = sdf_queries[fractal_sel_in[1:0]]; 
