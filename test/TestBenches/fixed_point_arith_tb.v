...
`include "fixed_point_arith.vh"
  ...
  // Helper functions to use in macros instead of system calls directly
  function real inv_sqrt_real; input real v; begin inv_sqrt_real = 1.0 / $sqrt(v); end endfunction
  function real floor_real; input real v; begin floor_real = $floor(v); end endfunction
  function real real_min; input real a; input real b; begin real_min = (a < b) ? a : b; end endfunction
  function real real_max; input real a; input real b; begin real_max = (a > b) ? a : b; end endfunction
  ...
  initial begin
    ...
    `TEST_FP_FUNC_2(real_min, fp_min, 6.696969, -3.111111) // Min
    `TEST_FP_FUNC_2(real_max, fp_max, 6.696969, -3.111111) // Max

    // Inverse Sqrt
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 0.5)
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 0.6)
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 0.7)
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 0.8)
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 0.9)
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 1.0)
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 3.7)
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 5.8)
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 1.5)
    `TEST_FP_OP_1(inv_sqrt_real, fp_inv_sqrt, 6.9)

    // Floor and Fract
    `TEST_FP_OP_1(floor_real, fp_floor, 0.5)
    `TEST_FP_OP_1(floor_real, fp_floor, -0.6)
    `TEST_FP_OP_1(floor_real, fp_floor, 1.6)
    `TEST_FP_OP_1(floor_real, fp_floor, -2.4)
