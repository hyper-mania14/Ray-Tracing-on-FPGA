...
// Menger Sponge SDF Constraints 
// They are kept explicitly NEGATIVE so that the `mmp()` function evaluating the interior tunnels 
`define FP_MAGIC_NUMBER_A  (-(32'sh000a6666 >>> (20 - `NUM_FRAC_DIGITS))) // approx -0.65 (tunnel threshold L1)
`define FP_MAGIC_NUMBER_B  (-(32'sh00026666 >>> (20 - `NUM_FRAC_DIGITS))) // approx -0.15 (tunnel threshold L2)
`define FP_MAGIC_NUMBER_C  (-(32'sh00026666 >>> (20 - `NUM_FRAC_DIGITS))) // approx -0.15 (tunnel threshold L3)
`define FP_MAGIC_NUMBER_D  (-(32'sh0000cccd >>> (20 - `NUM_FRAC_DIGITS))) // approx -0.08  (tunnel threshold L4)
`define FP_ONE_SIXTEENTHS  (32'sh00010000 >>> (20 - `NUM_FRAC_DIGITS)) // 1/16 = 0.0625

`define FP_TENTH           (32'sh0001999a >>> (20 - `NUM_FRAC_DIGITS)) // 1/10 = 0.1
`define FP_FIVE            (32'sh00500000 >>> (20 - `NUM_FRAC_DIGITS)) // 5.0
