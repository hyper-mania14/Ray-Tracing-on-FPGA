...
module vga_display (
    ...
    wire [23:0] hsl;
    assign hsl = hsl2rgb(
        hue_counter[27:20],                           // hue (top 8 bits of 28-bit counter)
        toggle_color ? 8'd165 : 8'd0,                 // saturation
        {read_data_in, 4'b0000}                       // lightness: 4-bit pixel -> 8-bit (equivalent to << 4)
    );
